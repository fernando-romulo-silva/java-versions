...
interface Shape {
    ...
    // This basically means a new method definition can be added to an interface and all the classes implementing this interface may or may not override the default method.
